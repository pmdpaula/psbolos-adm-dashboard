...
const GlassCardHover = ({ color, children, ...props }: GlassCardHoverProps) => {
  const theme = useTheme();

  if (!color) {
    color = theme.palette.primary.main; // Default to the primary color from the theme if none is provided
  }
